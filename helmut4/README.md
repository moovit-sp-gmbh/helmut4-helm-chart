...
| global | object | `{"environment":"production","imagePullPolicy":"IfNotPresent","imagePullSecrets":[{"name":"docker-registry-secret-json"}],"registry":"repo.moovit24.de:443","storage":{"csiDriver":"csi-driver-name","storageClassName":"helmut4-csi-storage","volumes":[{"appMount":true,"mountPath":"/Volumes/Helmut","name":"helmut-storage","size":"100Gi","source":""}]}}` | Cluster-wide defaults shared by every microservice Deployment. |
